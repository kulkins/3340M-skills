...
motor leftMotorA = motor(PORT6, ratio6_1, true);
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    // ........................................................................
    Controller1.ButtonL2.pressed(togglePiston);
...
int main() {
  ...
  Competition.autonomous(Skills_autonomous);
  ...
  while (true) {
    std::cout << "Angle: " << chassis.Gyro.heading(degrees) << " Degrees" << std::endl ;
    Brain.Screen.printAt(8, 130, "Angle: %.2f", chassis.Gyro.heading(degrees));
  }
}
